...
try:
    # SciPy>=1.6 renamed cumtrapz to cumulative_trapezoid.
...
class PathOptimizer:
    ...
    def sample_spiral(self, p):
        ...
        x_points = _cumtrapz(np.cos(t_points), s_points, initial=0.0)
        y_points = _cumtrapz(np.sin(t_points), s_points, initial=0.0)
