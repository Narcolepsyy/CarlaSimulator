...
# Camera parameters (relative to ego vehicle) used for visualization only.
CAMERA_IMAGE_SIZE = (960, 540)
CAMERA_POSITION   = (-6.0, 0.0, 2.5)  # meters: behind and slightly above car
CAMERA_ROTATION   = (0.0, 0.0, 0.0)   # degrees: keep pointed forward
...
def make_carla_settings(args):
    ...
    # Attach a third-person RGB camera so the simulation window shows the car.
    camera = sensor.Camera('CameraRGB')
    camera.set_image_size(*CAMERA_IMAGE_SIZE)
